...
<input type="button" value="MENU" class="cell-plugin" onClick="if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = '';this.innerText = ''; this.value = 'MENU'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = ''; this.value = 'MENU'; }">
</div>
...
<input class="button-auto" type="button" value="Multi <?php echo lang(334); ?>" onclick="window.open('sdl.php');return false;" />
<br />
<input class="button-auto" type="button" value="FileManager" onclick="window.open('index..php');return false;" />
<br />
<input class="button-auto" type="button" value="Media Player" onclick="window.open('dirLIST_files/media_player.php','Servecom', 'scrollbars=1, width=450,height=320');return false;" />
<br />
<input class="button-auto" type="button" value="Movie Tumbnailer" onclick="window.open('mtn.php');return false;" />
<br />
<input class="button-auto" type="button" value="Pictures Gallery" onclick="window.open('dirLIST_files/gallery.php', 'Servecom', 'scrollbars=1, width=780, height=640, resizable=1');return false;" />
<br />
<input class="button-auto" type="button" value="<?php echo lang(383); ?>" onclick="window.open('md5.php');return false;" />
</div>
</div>
...
<div style="margin:0px 0px 0px 0px">
<div class="smallfont" style="margin-bottom:0px">
<input type="button" value="<?php echo count($host); ?> <?php echo lang(333); ?>" class="button-auto" onClick="if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = '';this.innerText = ''; this.value = '<?php echo lang(333); ?>'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = ''; this.value = '<?php echo count($host); ?> <?php echo lang(333); ?>'; }">
</div>
<div style="margin: 0px; padding: 0px; border: 0px inset;">
<div style="display: none;">
<div dir="rtl" align="left" style="overflow-y:scroll; height:150px; padding-left:1px;">
<?php
ksort($host);
...
{
?>
<div class="rev-dev"><b><?php echo lang(376); ?></b></div>
<table border="0">
	<tr>

		<td height="100%" style="padding:0;">
			<div dir="rtl" align="left" style="padding-left:3px;">
<?php
...
<tr><td><br /><hr /><center><b><span><?php include ('online.php'); ?></span></b></center><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></td></tr>
